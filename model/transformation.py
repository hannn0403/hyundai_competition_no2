...
class TPS_SpatialTransformerNetwork(nn.Module):
    ...
    def __init__(self, config, F, I_size, I_r_size, I_channel_num=1):
        """ Based on RARE TPS
        input:
        ...
        self.GridGenerator = GridGenerator(self.device, self.F, self.I_r_size).to(self.device)
...
class GridGenerator(nn.Module):
    ...
    def __init__(self, device, F, I_r_size):
